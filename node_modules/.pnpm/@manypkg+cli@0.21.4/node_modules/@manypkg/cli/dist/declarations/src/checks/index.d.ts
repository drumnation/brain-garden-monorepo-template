export declare let checks: {
    ...
    WORKSPACE_REQUIRED: {
        type: "all";
        validate: (workspace: import("@manypkg/tools").Package, allWorkspaces: Map<string, import("@manypkg/tools").Package>, rootWorkspace: import("@manypkg/tools").Package | undefined, options: import("./utils").Options) => import("./WORKSPACE_REQUIRED").ErrorType[];
        fix: (error: import("./WORKSPACE_REQUIRED").ErrorType, options: import("./utils").Options) => void | {
            requiresInstall: boolean;
        };
        print: (error: import("./WORKSPACE_REQUIRED").ErrorType, options: import("./utils").Options) => string;
    };
};
