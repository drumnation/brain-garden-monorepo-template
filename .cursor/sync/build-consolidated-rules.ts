 ...
 *
 * Reads source rules from `.brain/rules/**/*.rules.mdc` and generates
 * platform-specific instruction files in `docs/ai-platforms/`.
 *
 * Usage:
...
const RULES_SOURCE_DIR = '.brain/rules';
...
function generateCLAUDEFormat(rules: Rule[]): string {
  ...
  output += 'This file is auto-generated from `.brain/rules/**/*.rules.mdc`.\n\n';
...
function build() {
  ...
  for (const context of contexts) {
    ...
    } else if (context.outputPath.endsWith('.clinerules')) {
