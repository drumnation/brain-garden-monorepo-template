...
**Applies to:** docs/**/*, **/README.md, **/CHANGELOG.md

---

### Electron + Express.js hexagonal architecture with functional DI patterns and modular structure
...
### Test-Driven Development workflow for PM Agent with Brain Garden integration
...
**Applies to:** **/*.test.ts, **/*.spec.ts, **/*.test.tsx, packages/core-*/**/*

---
- @agent-commander /Users/dmieloch/Dev/.pm-agent/docs/planning - we need to start implementing this actual plan, maybe a projects folder where we can begin to move, remove node_modules, reorg, the projects into their new structure, i'm not sure we picked a good final. It needs to be one where you don't have to move the project to keep it organized. We want the database to be how we keep track of the projects and keep them organized, not the folder structure.